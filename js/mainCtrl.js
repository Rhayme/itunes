angular.module('itunes').controller('mainCtrl', function($scope, itunesService) {
    ...
    //Our controller is what's going to connect our 'heavy lifting' itunesService with our view (index.html) so our user can see the
    // results they get back from itunes.
    ...
    $scope.getSongData = function(artist) {
        itunesService.getSongData(artist).then(function(songs) {
            console.log(songs);
